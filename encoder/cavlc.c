...
void x264_macroblock_write_cavlc( x264_t *h )
{
    ...
    dctcoef new_chroma_dc[8] = {0,3,4,0,3,0,0,1};
    dctcoef new_luma_dc[16] = {0,0,4,0,3,0,0,1,5,0,0,3,1,0,0,0};
    dctcoef new_chroma_ac[16] = {0,0,4,0,3,0,0,1,5,0,0,3,1,0,0,0};
